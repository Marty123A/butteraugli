...
[libjpeg](http://ijg.org/), [libwebp](https://developers.google.com/speed/webp)
and [libavif](https://github.com/AOMediaCodec/libavif) (with dav1d) are installed.
On some systems you might need to also install corresponding `-dev` packages.
...
comparison tool supports PNG, JPEG, WebP and AVIF images as inputs. To compare
images, run:

```
butteraugli image1.{png|jpg|webp|avif} image2.{png|jpg|webp|avif}
```
...
```
butteraugli image1.{png|jpg|webp|avif} image2.{png|jpg|webp|avif} heatmap.pnm
```
